...
console.error('Помилка при збереженні студента на сервері:', error);
        ...
        editStudent(student, index) {
            if (this.editingStudent._id != null) {
                
                const apiUrl = `http://34.82.81.113:3000/students/${this.editingStudent._id}/`;
                ...
                .then(data => {
                        ...
                        // student.mark = this.editedMark;
                        // student.isDonePr = this.editedIsDonePr;
                        // student.photo = this.editedPhoto; 

                        console.log(this.filteredStudents[index]);
                       this.filteredStudents[index] = data;
                       this.editingStudent = {id: null, name:""};
                })
                .catch(error => {
                    console.error('Помилка при збереженні студента на сервері:', error);
                });
                ...
                // this.editedPhoto = student.photo;
            }
        },
